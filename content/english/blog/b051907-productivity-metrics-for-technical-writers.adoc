...
* A reviewer’s quality rating is based on their assessment of the intrinsic characteristics of the document, such as completeness, accuracy, clarity, organization, style, and so forth.
