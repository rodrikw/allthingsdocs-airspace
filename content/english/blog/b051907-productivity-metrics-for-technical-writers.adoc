...
You could even make use of a document review checklist such as the one provided in _Developing Quality Technical information_.{empty}footnote:[Carey, M., Lanyi, M.M., Longo, D., Radzinski, E., Rouiller, S. and Wilde, E. (2014). _Developing Quality Technical Information: A Handbook for Writers and Editors_. IBM Press. p545.]
