...
You could even make use of a document review checklist such as the one provided in _Developing Quality Technical information_.{empty}footnote:[Carey, M., _et al_. (2014). p545.]
