...
A reviewer's quality rating is a summary of the reviewer's judgment of the document in terms of a number of quality characteristics such as completeness, accuracy, clarity, organization, style, and so forth.
